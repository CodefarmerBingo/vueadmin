    ...
    <el-tabs type="border-card">
      <el-tab-pane label="员工设置">
        ...
        <el-form :inline="true" :model="formInline" class="user-search">
          <el-form-item label="">
            <el-input size="small" v-model="formInline.perAreaNo" placeholder="输入地区代码"></el-input>
          </el-form-item>
          <el-form-item label="">
            <el-input size="small" v-model="formInline.perDeptNo" placeholder="输入部门代码"></el-input>
          </el-form-item>
          <el-form-item label="">
            <el-input size="small" v-model="formInline.perShowNo" placeholder="输入显示次序"></el-input>
          </el-form-item>
          <el-form-item label="">
            <el-input size="small" v-model="formInline.perPostPos" placeholder="输入岗位职务"></el-input>
          </el-form-item>
          <el-form-item label="">
            <el-input size="small" v-model="formInline.perName" placeholder="输入姓名"></el-input>
          </el-form-item>
          <el-form-item label="">
            <el-input size="small" v-model="formInline.perEngName" placeholder="输入英文姓名"></el-input>
          </el-form-item>
          <el-form-item label="">
            <el-input size="small" v-model="formInline.perWorkNo" placeholder="输入工号"></el-input>
          </el-form-item>
          <el-form-item label="">
            <el-input size="small" v-model="formInline.perDomNo" placeholder="输入域账号"></el-input>
          </el-form-item>
          <el-form-item label="">
            <el-input size="small" v-model="formInline.perEmail" placeholder="输入Email"></el-input>
          </el-form-item>
          <el-form-item label="">
            <el-input size="small" v-model="formInline.perIdcard" placeholder="输入身份证号"></el-input>
          </el-form-item>
          <el-form-item label="">
            <el-input size="small" v-model="formInline.perNote" placeholder="输入备注"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-tab-pane label="岗位变动历史">
        ...
        <el-form :inline="true" :model="formInline" class="user-search">
          <el-form-item label="">
            <el-input size="small" v-model="formInline.deptName" placeholder="输入角色代码"></el-input>
          </el-form-item>
          <el-form-item label="">
            <el-input size="small" v-model="formInline.deptNo" placeholder="输入角色名称"></el-input>
          </el-form-item>
          <el-form-item>
            <el-button size="small" type="primary" icon="el-icon-search" @click="search">搜索</el-button>
            <el-button size="small" type="primary" icon="el-icon-plus" @click="handleEdit()">添加</el-button>
...
<script>
import { deptList, deptSave, deptDelete } from '@/api/commonMG'
