 ...
 **/
// 部门/岗位/角色-获取数据
export const deptList = (params) => { return req("post", "platform-web/config/page", params) };
// 部门/岗位/角色-添加数据
export const deptSave = (params) => { return req("post", "platform-web/config/insertSelective", params) };
// 部门/岗位/角色-修改数据
export const deptUpdate = (params) => { return req("post", "platform-web/config/updateSelective", params) };
// 部门/岗位/角色-删除数据
export const deptDelete = (params) => { return  axios.delete("platform-web/config/delete?code=" + params)};
